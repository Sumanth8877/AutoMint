      ...
      <div className="grid w-full max-w-5xl gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        ...
        <div className="hidden lg:block">
          <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-border bg-white">
            <Image
              src="/illustrations/auth-sign-up.jpeg"
              alt="A small character at a workbench with a screwdriver, assembling a half-built mint helper robot from loose parts."
              fill
          ...
          <p className="mt-4 text-center text-sm text-muted">Build your mint helper — assembly starts here.</p>
        </div>
