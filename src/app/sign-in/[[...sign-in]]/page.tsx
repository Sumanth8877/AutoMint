  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_30%,rgba(124,58,237,0.15),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_70%,rgba(0,245,255,0.08),transparent_55%)]" />
      </div>
      ...
      <div className="mb-10 flex flex-col items-center gap-4">
        <div
          ...
          style={{ boxShadow: '0 0 40px rgba(0,245,255,0.20)' }}
        >
