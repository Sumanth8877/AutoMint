        ...
        <div className="flex items-center justify-between h-full">
          ...
          <Link href="/" className="flex items-center gap-2.5 group shrink-0">
            <div className="relative w-8 h-8 flex items-center justify-center">
              <Hexagon
                size={28}
                className="text-[#3B82F6] transition-all duration-500 group-hover:text-blue-400"
                strokeWidth={1.5}
              />
          ...
          <div className="flex items-center gap-3">
            {isSignedIn ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  href="/sign-in"
                  className="px-4 py-2 text-sm font-medium text-slate-400 hover:text-white rounded-xl transition-all duration-200"
                >
                  Sign In
                </Link>
              </div>
            ...
            <div className="pt-4 border-t border-white/5 mt-4 space-y-2">
              ...
              {!isSignedIn && (
                <Link
                  href="/sign-in"
                  onClick={() => setMobileOpen(false)}
                  className="block w-full text-center px-5 py-3 text-sm font-medium text-slate-400 rounded-xl border border-white/10 hover:bg-white/5"
                >
                  Sign In
                </Link>
              )}
